...
export namespace ceph {
    export namespace v1 {
        ...
        export interface CephBucketTopicSpecEndpointKafka {
             ...
             */
            mechanism: string;
            passwordSecretRef: outputs.ceph.v1.CephBucketTopicSpecEndpointKafkaPasswordSecretRef;
            /**
             ...
             */
            useSSL: boolean;
            userSecretRef: outputs.ceph.v1.CephBucketTopicSpecEndpointKafkaUserSecretRef;
        }
        ...
        export interface CephBucketTopicSpecEndpointKafkaPatch {
             ...
             */
            mechanism: string;
            passwordSecretRef: outputs.ceph.v1.CephBucketTopicSpecEndpointKafkaPasswordSecretRefPatch;
            /**
             * The URI of the Kafka endpoint to push notification to
             */
            uri: string;
             ...
             */
            useSSL: boolean;
            userSecretRef: outputs.ceph.v1.CephBucketTopicSpecEndpointKafkaUserSecretRefPatch;
        }
        ...
        export interface CephClientSpec {
             ...
             */
            secretName: string;
            security: outputs.ceph.v1.CephClientSpecSecurity;
        }
        ...
        export interface CephClientSpecPatch {
             ...
             */
            secretName: string;
            security: outputs.ceph.v1.CephClientSpecSecurityPatch;
        }
        ...
        export interface CephClientSpecSecurity {
            cephx: outputs.ceph.v1.CephClientSpecSecurityCephx;
        }
        ...
        export interface CephClientSpecSecurityPatch {
            cephx: outputs.ceph.v1.CephClientSpecSecurityCephxPatch;
        }
        ...
        export interface CephClusterSpec {
             ...
             */
            cephConfigFromSecret: {[key: string]: {[key: string]: {[key: string]: string}}};
        ...
        export interface CephClusterSpecSecurity {
            cephx: outputs.ceph.v1.CephClusterSpecSecurityCephx;
        ...
        export interface CephClusterSpecSecurityCephx {
            csi: outputs.ceph.v1.CephClusterSpecSecurityCephxCsi;
            daemon: outputs.ceph.v1.CephClusterSpecSecurityCephxDaemon;
            rbdMirrorPeer: outputs.ceph.v1.CephClusterSpecSecurityCephxRbdMirrorPeer;
        }
        ...
        export interface CephClusterSpecSecurityCephxPatch {
            csi: outputs.ceph.v1.CephClusterSpecSecurityCephxCsiPatch;
            daemon: outputs.ceph.v1.CephClusterSpecSecurityCephxDaemonPatch;
            rbdMirrorPeer: outputs.ceph.v1.CephClusterSpecSecurityCephxRbdMirrorPeerPatch;
        }
        ...
        export interface CephClusterSpecSecurityPatch {
            cephx: outputs.ceph.v1.CephClusterSpecSecurityCephxPatch;
        ...
        export interface CephFilesystemMirrorStatus {
            cephx: outputs.ceph.v1.CephFilesystemMirrorStatusCephx;
        ...
        export interface CephFilesystemMirrorStatusCephx {
            daemon: outputs.ceph.v1.CephFilesystemMirrorStatusCephxDaemon;
        }
         ...
         * Daemon shows the CephX key status for local Ceph daemons associated with this resources.
         */
        export interface CephFilesystemMirrorStatusCephxDaemonPatch {
            /**
             * KeyCephVersion reports the Ceph version that created the current generation's keys. This is
             * same string format as reported by `CephCluster.status.version.version` to allow them to be
             * compared. E.g., `20.2.0-0`.
        ...
        export interface CephFilesystemMirrorStatusCephxPatch {
            daemon: outputs.ceph.v1.CephFilesystemMirrorStatusCephxDaemonPatch;
        }
        ...
        export interface CephFilesystemMirrorStatusPatch {
            cephx: outputs.ceph.v1.CephFilesystemMirrorStatusCephxPatch;
        ...
        export interface CephNFSSpecSecurityKerberosConfigFilesVolumeSourceProjectedSources {
            ...
            podCertificate: outputs.ceph.v1.CephNFSSpecSecurityKerberosConfigFilesVolumeSourceProjectedSourcesPodCertificate;
        ...
        export interface CephNFSSpecSecurityKerberosConfigFilesVolumeSourceProjectedSourcesPatch {
            ...
            podCertificate: outputs.ceph.v1.CephNFSSpecSecurityKerberosConfigFilesVolumeSourceProjectedSourcesPodCertificatePatch;
        ...
        export interface CephNFSSpecSecurityKerberosKeytabFileVolumeSourceProjectedSources {
            ...
            podCertificate: outputs.ceph.v1.CephNFSSpecSecurityKerberosKeytabFileVolumeSourceProjectedSourcesPodCertificate;
        ...
        export interface CephNFSSpecSecurityKerberosKeytabFileVolumeSourceProjectedSourcesPatch {
            ...
            podCertificate: outputs.ceph.v1.CephNFSSpecSecurityKerberosKeytabFileVolumeSourceProjectedSourcesPodCertificatePatch;
        ...
        export interface CephNFSSpecSecuritySssdSidecarAdditionalFilesVolumeSourceProjectedSources {
            ...
            podCertificate: outputs.ceph.v1.CephNFSSpecSecuritySssdSidecarAdditionalFilesVolumeSourceProjectedSourcesPodCertificate;
        ...
        export interface CephNFSSpecSecuritySssdSidecarAdditionalFilesVolumeSourceProjectedSourcesPatch {
            ...
            podCertificate: outputs.ceph.v1.CephNFSSpecSecuritySssdSidecarAdditionalFilesVolumeSourceProjectedSourcesPodCertificatePatch;
        ...
        export interface CephNFSSpecSecuritySssdSidecarSssdConfigFileVolumeSourceProjectedSources {
            ...
            podCertificate: outputs.ceph.v1.CephNFSSpecSecuritySssdSidecarSssdConfigFileVolumeSourceProjectedSourcesPodCertificate;
        ...
        export interface CephNFSSpecSecuritySssdSidecarSssdConfigFileVolumeSourceProjectedSourcesPatch {
            ...
            podCertificate: outputs.ceph.v1.CephNFSSpecSecuritySssdSidecarSssdConfigFileVolumeSourceProjectedSourcesPodCertificatePatch;
        ...
        export interface CephNVMeOFGateway {
             ...
             */
            metadata: outputs.meta.v1.ObjectMeta;
            spec: outputs.ceph.v1.CephNVMeOFGatewaySpec;
            status: outputs.ceph.v1.CephNVMeOFGatewayStatus;
        }
        ...
        export interface CephNVMeOFGatewaySpec {
             ...
             */
            labels: {[key: string]: string};
            livenessProbe: outputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbe;
            /**
             ...
             */
            nvmeofConfig: {[key: string]: {[key: string]: string}};
            placement: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacement;
            /**
             * Pool is the RADOS pool where NVMe-oF configuration is stored
             */
            pool: string;
            ports: outputs.ceph.v1.CephNVMeOFGatewaySpecPorts;
            /**
             * PriorityClassName sets the priority class on the pods
             */
            priorityClassName: string;
            resources: outputs.ceph.v1.CephNVMeOFGatewaySpecResources;
        }
        ...
        export interface CephNVMeOFGatewaySpecLivenessProbe {
             ...
             */
            disabled: boolean;
            probe: outputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbe;
        }
        ...
        export interface CephNVMeOFGatewaySpecLivenessProbePatch {
             ...
             */
            disabled: boolean;
            probe: outputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbePatch;
        }
        ...
        export interface CephNVMeOFGatewaySpecLivenessProbeProbe {
            exec: outputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeExec;
            /**
             * Minimum consecutive failures for the probe to be considered failed after having succeeded.
             * Defaults to 3. Minimum value is 1.
             */
            failureThreshold: number;
            grpc: outputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeGrpc;
            httpGet: outputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeHttpGet;
            /**
             * Number of seconds after the container has started before liveness probes are initiated.
             * More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
             */
             ...
             */
            successThreshold: number;
            tcpSocket: outputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeTcpSocket;
            terminationGracePeriodSeconds: number;
            /**
             * Number of seconds after which the probe times out.
             * Defaults to 1 second. Minimum value is 1.
        ...
        export interface CephNVMeOFGatewaySpecLivenessProbeProbeHttpGet {
             ...
             * Custom headers to set in the request. HTTP allows repeated headers.
             */
            httpHeaders: outputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeHttpGetHttpHeaders[];
            /**
             * Path to access on the HTTP server.
             */
            path: string;
        ...
        export interface CephNVMeOFGatewaySpecLivenessProbeProbeHttpGetPatch {
             ...
             * Custom headers to set in the request. HTTP allows repeated headers.
             */
            httpHeaders: outputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeHttpGetHttpHeadersPatch[];
            /**
             * Path to access on the HTTP server.
             */
            path: string;
        ...
        export interface CephNVMeOFGatewaySpecLivenessProbeProbePatch {
            exec: outputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeExecPatch;
            /**
             * Minimum consecutive failures for the probe to be considered failed after having succeeded.
             * Defaults to 3. Minimum value is 1.
             */
            failureThreshold: number;
            grpc: outputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeGrpcPatch;
            httpGet: outputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeHttpGetPatch;
            /**
             * Number of seconds after the container has started before liveness probes are initiated.
             * More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
             */
             ...
             */
            successThreshold: number;
            tcpSocket: outputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeTcpSocketPatch;
            terminationGracePeriodSeconds: number;
            /**
             * Number of seconds after which the probe times out.
             * Defaults to 1 second. Minimum value is 1.
        ...
        export interface CephNVMeOFGatewaySpecPatch {
             ...
             */
            labels: {[key: string]: string};
            livenessProbe: outputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbePatch;
            /**
             * NVMeOFConfig is a map of section names to key-value pairs for nvmeof.conf configuration
             * This allows users to override or add configuration options without needing to manage a ConfigMap
             */
            nvmeofConfig: {[key: string]: {[key: string]: string}};
            placement: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPatch;
            /**
             * Pool is the RADOS pool where NVMe-oF configuration is stored
             */
            pool: string;
            ports: outputs.ceph.v1.CephNVMeOFGatewaySpecPortsPatch;
            /**
             * PriorityClassName sets the priority class on the pods
             */
            priorityClassName: string;
            resources: outputs.ceph.v1.CephNVMeOFGatewaySpecResourcesPatch;
        }

        export interface CephNVMeOFGatewaySpecPlacement {
            nodeAffinity: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinity;
            podAffinity: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinity;
            podAntiAffinity: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinity;
            tolerations: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTolerations[];
            topologySpreadConstraints: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTopologySpreadConstraints[];
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinity {
            preferredDuringSchedulingIgnoredDuringExecution: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecution[];
            requiredDuringSchedulingIgnoredDuringExecution: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecution;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityPatch {
            preferredDuringSchedulingIgnoredDuringExecution: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPatch[];
            requiredDuringSchedulingIgnoredDuringExecution: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionPatch;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecution {
            preference: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreference;
            weight: number;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPatch {
            preference: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferencePatch;
            weight: number;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreference {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpressions[];
            matchFields: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchFields[];
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferencePatch {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpressionsPatch[];
            matchFields: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchFieldsPatch[];
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecution {
            nodeSelectorTerms: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTerms[];
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTerms {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchExpressions[];
            matchFields: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchFields[];
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsPatch {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchExpressionsPatch[];
            matchFields: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchFieldsPatch[];
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionPatch {
            nodeSelectorTerms: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsPatch[];
        }

        export interface CephNVMeOFGatewaySpecPlacementPatch {
            nodeAffinity: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPatch;
            podAffinity: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPatch;
            podAntiAffinity: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPatch;
            tolerations: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTolerationsPatch[];
            topologySpreadConstraints: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsPatch[];
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinity {
            preferredDuringSchedulingIgnoredDuringExecution: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecution[];
            requiredDuringSchedulingIgnoredDuringExecution: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecution[];
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPatch {
            preferredDuringSchedulingIgnoredDuringExecution: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPatch[];
            requiredDuringSchedulingIgnoredDuringExecution: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionPatch[];
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecution {
            podAffinityTerm: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTerm;
            weight: number;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPatch {
            podAffinityTerm: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermPatch;
            weight: number;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTerm {
            labelSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelector;
            matchLabelKeys: string[];
            mismatchLabelKeys: string[];
            namespaceSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelector;
            namespaces: string[];
            topologyKey: string;
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelector {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorMatchExpressions[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorPatch {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorMatchExpressionsPatch[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelector {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorMatchExpressions[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorPatch {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorMatchExpressionsPatch[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermPatch {
            labelSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorPatch;
            matchLabelKeys: string[];
            mismatchLabelKeys: string[];
            namespaceSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorPatch;
            namespaces: string[];
            topologyKey: string;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecution {
            labelSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelector;
            matchLabelKeys: string[];
            mismatchLabelKeys: string[];
            namespaceSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelector;
            namespaces: string[];
            topologyKey: string;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelector {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorMatchExpressions[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorPatch {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorMatchExpressionsPatch[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelector {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorMatchExpressions[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorPatch {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorMatchExpressionsPatch[];
            matchLabels: {[key: string]: string};
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionPatch {
            labelSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorPatch;
            matchLabelKeys: string[];
            mismatchLabelKeys: string[];
            namespaceSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorPatch;
            namespaces: string[];
            topologyKey: string;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinity {
            preferredDuringSchedulingIgnoredDuringExecution: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecution[];
            requiredDuringSchedulingIgnoredDuringExecution: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution[];
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPatch {
            preferredDuringSchedulingIgnoredDuringExecution: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPatch[];
            requiredDuringSchedulingIgnoredDuringExecution: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionPatch[];
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecution {
            podAffinityTerm: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTerm;
            weight: number;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPatch {
            podAffinityTerm: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermPatch;
            weight: number;
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTerm {
            labelSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelector;
            matchLabelKeys: string[];
            mismatchLabelKeys: string[];
            namespaceSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelector;
            namespaces: string[];
            topologyKey: string;
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelector {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorMatchExpressions[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorPatch {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorMatchExpressionsPatch[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelector {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorMatchExpressions[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorPatch {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorMatchExpressionsPatch[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermPatch {
            labelSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorPatch;
            matchLabelKeys: string[];
            mismatchLabelKeys: string[];
            namespaceSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorPatch;
            namespaces: string[];
            topologyKey: string;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution {
            labelSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelector;
            matchLabelKeys: string[];
            mismatchLabelKeys: string[];
            namespaceSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelector;
            namespaces: string[];
            topologyKey: string;
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelector {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorMatchExpressions[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorPatch {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorMatchExpressionsPatch[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelector {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorMatchExpressions[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorPatch {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorMatchExpressionsPatch[];
            matchLabels: {[key: string]: string};
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionPatch {
            labelSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorPatch;
            matchLabelKeys: string[];
            mismatchLabelKeys: string[];
            namespaceSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorPatch;
            namespaces: string[];
            topologyKey: string;
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementTopologySpreadConstraints {
            labelSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsLabelSelector;
            matchLabelKeys: string[];
            maxSkew: number;
            minDomains: number;
            nodeAffinityPolicy: string;
        ...
        export interface CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsLabelSelector {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsLabelSelectorMatchExpressions[];
            matchLabels: {[key: string]: string};
        }
        ...
        export interface CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsLabelSelectorPatch {
            matchExpressions: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsLabelSelectorMatchExpressionsPatch[];
            matchLabels: {[key: string]: string};
        }

        export interface CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsPatch {
            labelSelector: outputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsLabelSelectorPatch;
            matchLabelKeys: string[];
            maxSkew: number;
            minDomains: number;
            nodeAffinityPolicy: string;
        ...
        export interface CephNVMeOFGatewaySpecResources {
             ...
             * This field is immutable. It can only be set for containers.
             */
            claims: outputs.ceph.v1.CephNVMeOFGatewaySpecResourcesClaims[];
            /**
             * Limits describes the maximum amount of compute resources allowed.
             * More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
             */
        ...
        export interface CephNVMeOFGatewaySpecResourcesPatch {
             ...
             * This field is immutable. It can only be set for containers.
             */
            claims: outputs.ceph.v1.CephNVMeOFGatewaySpecResourcesClaimsPatch[];
            /**
             * Limits describes the maximum amount of compute resources allowed.
             * More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
             */
        ...
        export interface CephNVMeOFGatewayStatus {
            cephx: outputs.ceph.v1.CephNVMeOFGatewayStatusCephx;
            conditions: outputs.ceph.v1.CephNVMeOFGatewayStatusConditions[];
            /**
             * ObservedGeneration is the latest generation observed by the controller.
             */
            observedGeneration: number;
        ...
        export interface CephNVMeOFGatewayStatusCephx {
            daemon: outputs.ceph.v1.CephNVMeOFGatewayStatusCephxDaemon;
        }
         ...
         * Daemon shows the CephX key status for local Ceph daemons associated with this resources.
         */
        export interface CephNVMeOFGatewayStatusCephxDaemonPatch {
            /**
             * KeyCephVersion reports the Ceph version that created the current generation's keys. This is
             * same string format as reported by `CephCluster.status.version.version` to allow them to be
             * compared. E.g., `20.2.0-0`.
        ...
        export interface CephNVMeOFGatewayStatusCephxPatch {
            daemon: outputs.ceph.v1.CephNVMeOFGatewayStatusCephxDaemonPatch;
        }
         ...
         * Condition represents a status condition on any Rook-Ceph Custom Resource.
         */
        export interface CephNVMeOFGatewayStatusConditionsPatch {
            lastHeartbeatTime: string;
            lastTransitionTime: string;
            message: string;
            /**
         ...
         * NVMeOFGatewayStatus represents the status of Ceph NVMe-oF Gateway
         */
        export interface CephNVMeOFGatewayStatusPatch {
            cephx: outputs.ceph.v1.CephNVMeOFGatewayStatusCephxPatch;
            conditions: outputs.ceph.v1.CephNVMeOFGatewayStatusConditionsPatch[];
            /**
             * ObservedGeneration is the latest generation observed by the controller.
             */
            observedGeneration: number;
        ...
        export interface CephObjectStoreSpecGateway {
             ...
             */
            priorityClassName: string;
            readAffinity: outputs.ceph.v1.CephObjectStoreSpecGatewayReadAffinity;
            /**
             ...
             * applied. Use with caution.
             */
            rgwConfigFromSecret: {[key: string]: {[key: string]: string}};
            /**
        ...
        export interface CephObjectStoreSpecGatewayAdditionalVolumeMountsVolumeSourceProjectedSources {
            ...
            podCertificate: outputs.ceph.v1.CephObjectStoreSpecGatewayAdditionalVolumeMountsVolumeSourceProjectedSourcesPodCertificate;
        ...
        export interface CephObjectStoreSpecGatewayAdditionalVolumeMountsVolumeSourceProjectedSourcesPatch {
            ...
            podCertificate: outputs.ceph.v1.CephObjectStoreSpecGatewayAdditionalVolumeMountsVolumeSourceProjectedSourcesPodCertificatePatch;
        ...
        export interface CephObjectStoreSpecGatewayPatch {
             ...
             */
            priorityClassName: string;
            readAffinity: outputs.ceph.v1.CephObjectStoreSpecGatewayReadAffinityPatch;
            /**
             * The resource requirements for the rgw pods
             */
            resources: {[key: string]: any};
        ...
        export interface CephObjectStoreUserSpec {
             ...
             * will generate them.
             */
            keys: outputs.ceph.v1.CephObjectStoreUserSpecKeys[];
            /**
        ...
        export interface CephObjectStoreUserSpecKeys {
            accessKeyRef: outputs.ceph.v1.CephObjectStoreUserSpecKeysAccessKeyRef;
            secretKeyRef: outputs.ceph.v1.CephObjectStoreUserSpecKeysSecretKeyRef;
        }
        ...
        export interface CephObjectStoreUserSpecKeysPatch {
            accessKeyRef: outputs.ceph.v1.CephObjectStoreUserSpecKeysAccessKeyRefPatch;
            secretKeyRef: outputs.ceph.v1.CephObjectStoreUserSpecKeysSecretKeyRefPatch;
        }
        ...
        export interface CephObjectStoreUserSpecPatch {
             ...
             * will generate them.
             */
            keys: outputs.ceph.v1.CephObjectStoreUserSpecKeysPatch[];
            /**
             * The op-mask of the user.
             */
            opMask: string[];
