...
export namespace ceph {
    export namespace v1 {
        ...
        export interface CephBucketTopicSpecEndpointKafka {
            ...
            passwordSecretRef?: pulumi.Input<inputs.ceph.v1.CephBucketTopicSpecEndpointKafkaPasswordSecretRef>;
            /**
            ...
            userSecretRef?: pulumi.Input<inputs.ceph.v1.CephBucketTopicSpecEndpointKafkaUserSecretRef>;
        }

        /**
         * The kafka password to use for authentication
         */
        export interface CephBucketTopicSpecEndpointKafkaPasswordSecretRef {
            /**
         ...
         * The kafka password to use for authentication
         */
        export interface CephBucketTopicSpecEndpointKafkaPasswordSecretRefPatch {
            /**
             * The key of the secret to select from.  Must be a valid secret key.
             */
            key?: pulumi.Input<string>;
        ...
        export interface CephBucketTopicSpecEndpointKafkaPatch {
             ...
             */
            mechanism?: pulumi.Input<string>;
            passwordSecretRef?: pulumi.Input<inputs.ceph.v1.CephBucketTopicSpecEndpointKafkaPasswordSecretRefPatch>;
            /**
             * The URI of the Kafka endpoint to push notification to
             */
            uri?: pulumi.Input<string>;
             ...
             */
            useSSL?: pulumi.Input<boolean>;
            userSecretRef?: pulumi.Input<inputs.ceph.v1.CephBucketTopicSpecEndpointKafkaUserSecretRefPatch>;
        }

        /**
         * The kafka user name to use for authentication
         */
        export interface CephBucketTopicSpecEndpointKafkaUserSecretRef {
            /**
             * The key of the secret to select from.  Must be a valid secret key.
             */
            key?: pulumi.Input<string>;
         ...
         * The kafka user name to use for authentication
         */
        export interface CephBucketTopicSpecEndpointKafkaUserSecretRefPatch {
            /**
             * The key of the secret to select from.  Must be a valid secret key.
             */
            key?: pulumi.Input<string>;
        ...
        export interface CephClientSpec {
             ...
             */
            removeSecret?: pulumi.Input<boolean>;
            /**
            ...
            security?: pulumi.Input<inputs.ceph.v1.CephClientSpecSecurity>;
        }
        ...
        export interface CephClientSpecPatch {
             ...
             */
            secretName?: pulumi.Input<string>;
            security?: pulumi.Input<inputs.ceph.v1.CephClientSpecSecurityPatch>;
        }

        /**
         * Security represents security settings
         */
        export interface CephClientSpecSecurity {
            cephx?: pulumi.Input<inputs.ceph.v1.CephClientSpecSecurityCephx>;
        }

        /**
         * CephX configures CephX key settings. More: https://docs.ceph.com/en/latest/dev/cephx/
         */
        export interface CephClientSpecSecurityCephx {
            /**
             ...
             * are not rotated.
             */
            keyGeneration?: pulumi.Input<number>;
            /**
             ...
             */
            keyRotationPolicy?: pulumi.Input<string>;
        }

        /**
         * CephX configures CephX key settings. More: https://docs.ceph.com/en/latest/dev/cephx/
         */
        export interface CephClientSpecSecurityCephxPatch {
            /**
             * KeyGeneration specifies the desired CephX key generation. This is used when KeyRotationPolicy
             * is KeyGeneration and ignored for other policies. If this is set to greater than the current
             * key generation, relevant keys will be rotated, and the generation value will be updated to
         ...
         * Security represents security settings
         */
        export interface CephClientSpecSecurityPatch {
            cephx?: pulumi.Input<inputs.ceph.v1.CephClientSpecSecurityCephxPatch>;
        }
        ...
        export interface CephClusterSpec {
             ...
             */
            cephConfigFromSecret?: pulumi.Input<{[key: string]: pulumi.Input<{[key: string]: pulumi.Input<{[key: string]: pulumi.Input<string>}>}>}>;
        ...
        export interface CephClusterSpecCleanupPolicy {
             ...
             */
            wipeDevicesFromOtherClusters?: pulumi.Input<boolean>;
        }
        ...
        export interface CephClusterSpecCsi {
             ...
             */
            skipUserCreation?: pulumi.Input<boolean>;
        }
        ...
        export interface CephClusterSpecMon {
             ...
             * leading
             */
            externalMonIDs?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface CephClusterSpecSecurity {
            cephx?: pulumi.Input<inputs.ceph.v1.CephClusterSpecSecurityCephx>;
         ...
         * CephX configures CephX key settings. More: https://docs.ceph.com/en/latest/dev/cephx/
         */
        export interface CephClusterSpecSecurityCephx {
            csi?: pulumi.Input<inputs.ceph.v1.CephClusterSpecSecurityCephxCsi>;
            daemon?: pulumi.Input<inputs.ceph.v1.CephClusterSpecSecurityCephxDaemon>;
            rbdMirrorPeer?: pulumi.Input<inputs.ceph.v1.CephClusterSpecSecurityCephxRbdMirrorPeer>;
        }
         ...
         */
        export interface CephClusterSpecSecurityCephxCsi {
            /**
             ...
             */
            keepPriorKeyCountMax?: pulumi.Input<number>;
            /**
             * KeyGeneration specifies the desired CephX key generation. This is used when KeyRotationPolicy
             * is KeyGeneration and ignored for other policies. If this is set to greater than the current
             * key generation, relevant keys will be rotated, and the generation value will be updated to
         ...
         * CSI key rotation can affect existing PV connections, so take care when exercising this option.
         */
        export interface CephClusterSpecSecurityCephxCsiPatch {
            /**
             * KeepPriorKeyCountMax tells Rook how many prior keys to keep active.
             * Generally, this would be set to 1 to allow for a migration period for applications.
             * If desired, set this to 0 to delete prior keys after migration.
         ...
         */
        export interface CephClusterSpecSecurityCephxDaemon {
            /**
             * KeyGeneration specifies the desired CephX key generation. This is used when KeyRotationPolicy
             * is KeyGeneration and ignored for other policies. If this is set to greater than the current
             * key generation, relevant keys will be rotated, and the generation value will be updated to
         ...
         * Ceph cluster. Daemon CephX keys can be rotated without affecting client connections.
         */
        export interface CephClusterSpecSecurityCephxDaemonPatch {
            /**
             * KeyGeneration specifies the desired CephX key generation. This is used when KeyRotationPolicy
             * is KeyGeneration and ignored for other policies. If this is set to greater than the current
             * key generation, relevant keys will be rotated, and the generation value will be updated to
         ...
         * CephX configures CephX key settings. More: https://docs.ceph.com/en/latest/dev/cephx/
         */
        export interface CephClusterSpecSecurityCephxPatch {
            csi?: pulumi.Input<inputs.ceph.v1.CephClusterSpecSecurityCephxCsiPatch>;
            daemon?: pulumi.Input<inputs.ceph.v1.CephClusterSpecSecurityCephxDaemonPatch>;
            rbdMirrorPeer?: pulumi.Input<inputs.ceph.v1.CephClusterSpecSecurityCephxRbdMirrorPeerPatch>;
        }
         ...
         */
        export interface CephClusterSpecSecurityCephxRbdMirrorPeer {
            /**
             * KeyGeneration specifies the desired CephX key generation. This is used when KeyRotationPolicy
             * is KeyGeneration and ignored for other policies. If this is set to greater than the current
             * key generation, relevant keys will be rotated, and the generation value will be updated to
         ...
         * Rotation will affect any existing peers connected to this cluster, so take care when exercising this option.
         */
        export interface CephClusterSpecSecurityCephxRbdMirrorPeerPatch {
            /**
             * KeyGeneration specifies the desired CephX key generation. This is used when KeyRotationPolicy
             * is KeyGeneration and ignored for other policies. If this is set to greater than the current
             * key generation, relevant keys will be rotated, and the generation value will be updated to
        ...
        export interface CephClusterSpecSecurityPatch {
            cephx?: pulumi.Input<inputs.ceph.v1.CephClusterSpecSecurityCephxPatch>;
        ...
        export interface CephClusterSpecStorage {
             ...
             */
            osdMaxUpdatesInParallel?: pulumi.Input<number>;
            /**
        ...
        export interface CephFilesystemMirrorStatus {
            cephx?: pulumi.Input<inputs.ceph.v1.CephFilesystemMirrorStatusCephx>;
        ...
        export interface CephFilesystemMirrorStatusCephx {
            daemon?: pulumi.Input<inputs.ceph.v1.CephFilesystemMirrorStatusCephxDaemon>;
        }

        /**
         * Daemon shows the CephX key status for local Ceph daemons associated with this resources.
         */
        export interface CephFilesystemMirrorStatusCephxDaemon {
            /**
             ...
             */
            keyCephVersion?: pulumi.Input<string>;
            /**
        ...
        export interface CephFilesystemSpecMetadataServer {
             ...
             */
            cacheMemoryLimitFactor?: pulumi.Input<number>;
            /**
             ...
             */
            cacheMemoryRequestFactor?: pulumi.Input<number>;
            /**
             * The labels-related configuration to add/set on each Pod related object.
             */
            labels?: pulumi.Input<{[key: string]: any}>;
        ...
        export interface CephNFSSpecSecurityKerberosConfigFilesVolumeSourceProjectedSources {
            ...
            podCertificate?: pulumi.Input<inputs.ceph.v1.CephNFSSpecSecurityKerberosConfigFilesVolumeSourceProjectedSourcesPodCertificate>;
        ...
        export interface CephNFSSpecSecurityKerberosConfigFilesVolumeSourceProjectedSourcesPatch {
            ...
            podCertificate?: pulumi.Input<inputs.ceph.v1.CephNFSSpecSecurityKerberosConfigFilesVolumeSourceProjectedSourcesPodCertificatePatch>;
        ...
        export interface CephNFSSpecSecurityKerberosConfigFilesVolumeSourceProjectedSourcesPodCertificate {
        ...
        export interface CephNFSSpecSecurityKerberosConfigFilesVolumeSourceProjectedSourcesPodCertificatePatch {
            certificateChainPath?: pulumi.Input<string>;
            credentialBundlePath?: pulumi.Input<string>;
            keyPath?: pulumi.Input<string>;
            keyType?: pulumi.Input<string>;
        ...
        export interface CephNFSSpecSecurityKerberosKeytabFileVolumeSourceProjectedSources {
            ...
            podCertificate?: pulumi.Input<inputs.ceph.v1.CephNFSSpecSecurityKerberosKeytabFileVolumeSourceProjectedSourcesPodCertificate>;
        ...
        export interface CephNFSSpecSecurityKerberosKeytabFileVolumeSourceProjectedSourcesPatch {
            ...
            podCertificate?: pulumi.Input<inputs.ceph.v1.CephNFSSpecSecurityKerberosKeytabFileVolumeSourceProjectedSourcesPodCertificatePatch>;
        ...
        export interface CephNFSSpecSecurityKerberosKeytabFileVolumeSourceProjectedSourcesPodCertificate {
            certificateChainPath?: pulumi.Input<string>;
            credentialBundlePath?: pulumi.Input<string>;
            keyPath?: pulumi.Input<string>;
            keyType?: pulumi.Input<string>;
        ...
        export interface CephNFSSpecSecurityKerberosKeytabFileVolumeSourceProjectedSourcesPodCertificatePatch {
            certificateChainPath?: pulumi.Input<string>;
            credentialBundlePath?: pulumi.Input<string>;
            keyPath?: pulumi.Input<string>;
            keyType?: pulumi.Input<string>;
        ...
        export interface CephNFSSpecSecuritySssdSidecarAdditionalFilesVolumeSourceProjectedSources {
            ...
            podCertificate?: pulumi.Input<inputs.ceph.v1.CephNFSSpecSecuritySssdSidecarAdditionalFilesVolumeSourceProjectedSourcesPodCertificate>;
        ...
        export interface CephNFSSpecSecuritySssdSidecarAdditionalFilesVolumeSourceProjectedSourcesPatch {
            ...
            podCertificate?: pulumi.Input<inputs.ceph.v1.CephNFSSpecSecuritySssdSidecarAdditionalFilesVolumeSourceProjectedSourcesPodCertificatePatch>;
        ...
        export interface CephNFSSpecSecuritySssdSidecarAdditionalFilesVolumeSourceProjectedSourcesPodCertificate {
            certificateChainPath?: pulumi.Input<string>;
            credentialBundlePath?: pulumi.Input<string>;
            keyPath?: pulumi.Input<string>;
            keyType?: pulumi.Input<string>;
        ...
        export interface CephNFSSpecSecuritySssdSidecarAdditionalFilesVolumeSourceProjectedSourcesPodCertificatePatch {
            certificateChainPath?: pulumi.Input<string>;
            credentialBundlePath?: pulumi.Input<string>;
            keyPath?: pulumi.Input<string>;
            keyType?: pulumi.Input<string>;
        ...
        export interface CephNFSSpecSecuritySssdSidecarSssdConfigFileVolumeSourceProjectedSources {
            ...
            podCertificate?: pulumi.Input<inputs.ceph.v1.CephNFSSpecSecuritySssdSidecarSssdConfigFileVolumeSourceProjectedSourcesPodCertificate>;
        ...
        export interface CephNFSSpecSecuritySssdSidecarSssdConfigFileVolumeSourceProjectedSourcesPatch {
            ...
            podCertificate?: pulumi.Input<inputs.ceph.v1.CephNFSSpecSecuritySssdSidecarSssdConfigFileVolumeSourceProjectedSourcesPodCertificatePatch>;
        ...
        export interface CephNFSSpecSecuritySssdSidecarSssdConfigFileVolumeSourceProjectedSourcesPodCertificate {
            certificateChainPath?: pulumi.Input<string>;
            credentialBundlePath?: pulumi.Input<string>;
            keyPath?: pulumi.Input<string>;
            keyType?: pulumi.Input<string>;
        ...
        export interface CephNFSSpecSecuritySssdSidecarSssdConfigFileVolumeSourceProjectedSourcesPodCertificatePatch {
            certificateChainPath?: pulumi.Input<string>;
            credentialBundlePath?: pulumi.Input<string>;
            keyPath?: pulumi.Input<string>;
            keyType?: pulumi.Input<string>;
         ...
         */
        export interface CephNVMeOFGateway {
            /**
             * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
             */
            apiVersion?: pulumi.Input<"ceph.rook.io/v1">;
             ...
             * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
             */
            kind?: pulumi.Input<"CephNVMeOFGateway">;
            /**
             * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
             */
            metadata?: pulumi.Input<inputs.meta.v1.ObjectMeta>;
            spec?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpec>;
            status?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewayStatus>;
        }

        /**
         * NVMeOFGatewaySpec represents the spec of an NVMe-oF gateway
         */
        export interface CephNVMeOFGatewaySpec {
            /**
             * The annotations-related configuration to add/set on each Pod related object.
             */
            annotations?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
             ...
             */
            labels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
            livenessProbe?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbe>;
            /**
             ...
             */
            nvmeofConfig?: pulumi.Input<{[key: string]: pulumi.Input<{[key: string]: pulumi.Input<string>}>}>;
            placement?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacement>;
            /**
             * Pool is the RADOS pool where NVMe-oF configuration is stored
             */
            pool?: pulumi.Input<string>;
            ports?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPorts>;
            /**
             * PriorityClassName sets the priority class on the pods
             */
            priorityClassName?: pulumi.Input<string>;
            resources?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecResources>;
        }
         ...
         * If LivenessProbe.Disabled is false and LivenessProbe.Probe is nil uses default probe.
         */
        export interface CephNVMeOFGatewaySpecLivenessProbe {
            /**
             * Disabled determines whether probe is disable or not
             */
            disabled?: pulumi.Input<boolean>;
            probe?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbe>;
        }
         ...
         * If LivenessProbe.Disabled is false and LivenessProbe.Probe is nil uses default probe.
         */
        export interface CephNVMeOFGatewaySpecLivenessProbePatch {
            /**
             * Disabled determines whether probe is disable or not
             */
            disabled?: pulumi.Input<boolean>;
            probe?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbePatch>;
        }
         ...
         * alive or ready to receive traffic.
         */
        export interface CephNVMeOFGatewaySpecLivenessProbeProbe {
            exec?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeExec>;
            /**
             * Minimum consecutive failures for the probe to be considered failed after having succeeded.
             * Defaults to 3. Minimum value is 1.
             */
            failureThreshold?: pulumi.Input<number>;
            grpc?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeGrpc>;
            httpGet?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeHttpGet>;
            /**
             * Number of seconds after the container has started before liveness probes are initiated.
             * More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
             */
             ...
             */
            successThreshold?: pulumi.Input<number>;
            tcpSocket?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeTcpSocket>;
            terminationGracePeriodSeconds?: pulumi.Input<number>;
            /**
             * Number of seconds after which the probe times out.
             * Defaults to 1 second. Minimum value is 1.
         ...
         * Exec specifies a command to execute in the container.
         */
        export interface CephNVMeOFGatewaySpecLivenessProbeProbeExec {
            /**
             * Command is the command line to execute inside the container, the working directory for the
             * command  is root ('/') in the container's filesystem. The command is simply exec'd, it is
             * not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use
         ...
         * Exec specifies a command to execute in the container.
         */
        export interface CephNVMeOFGatewaySpecLivenessProbeProbeExecPatch {
            /**
             * Command is the command line to execute inside the container, the working directory for the
             * command  is root ('/') in the container's filesystem. The command is simply exec'd, it is
             * not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use
         ...
         * GRPC specifies a GRPC HealthCheckRequest.
         */
        export interface CephNVMeOFGatewaySpecLivenessProbeProbeGrpc {
            /**
             * Port number of the gRPC service. Number must be in the range 1 to 65535.
             */
            port?: pulumi.Input<number>;
         ...
         * GRPC specifies a GRPC HealthCheckRequest.
         */
        export interface CephNVMeOFGatewaySpecLivenessProbeProbeGrpcPatch {
            /**
             * Port number of the gRPC service. Number must be in the range 1 to 65535.
             */
            port?: pulumi.Input<number>;
         ...
         * HTTPGet specifies an HTTP GET request to perform.
         */
        export interface CephNVMeOFGatewaySpecLivenessProbeProbeHttpGet {
            /**
             * Host name to connect to, defaults to the pod IP. You probably want to set
             * "Host" in httpHeaders instead.
             */
             ...
             * Custom headers to set in the request. HTTP allows repeated headers.
             */
            httpHeaders?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeHttpGetHttpHeaders>[]>;
            /**
             * Path to access on the HTTP server.
             */
            path?: pulumi.Input<string>;
         ...
         * HTTPHeader describes a custom header to be used in HTTP probes
         */
        export interface CephNVMeOFGatewaySpecLivenessProbeProbeHttpGetHttpHeaders {
            /**
             * The header field name.
             * This will be canonicalized upon output, so case-variant names will be understood as the same header.
             */
         ...
         * HTTPHeader describes a custom header to be used in HTTP probes
         */
        export interface CephNVMeOFGatewaySpecLivenessProbeProbeHttpGetHttpHeadersPatch {
            /**
             * The header field name.
             * This will be canonicalized upon output, so case-variant names will be understood as the same header.
             */
         ...
         * HTTPGet specifies an HTTP GET request to perform.
         */
        export interface CephNVMeOFGatewaySpecLivenessProbeProbeHttpGetPatch {
            /**
             * Host name to connect to, defaults to the pod IP. You probably want to set
             * "Host" in httpHeaders instead.
             */
             ...
             * Custom headers to set in the request. HTTP allows repeated headers.
             */
            httpHeaders?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeHttpGetHttpHeadersPatch>[]>;
            /**
             * Path to access on the HTTP server.
             */
            path?: pulumi.Input<string>;
         ...
         * alive or ready to receive traffic.
         */
        export interface CephNVMeOFGatewaySpecLivenessProbeProbePatch {
            exec?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeExecPatch>;
            /**
             * Minimum consecutive failures for the probe to be considered failed after having succeeded.
             * Defaults to 3. Minimum value is 1.
             */
            failureThreshold?: pulumi.Input<number>;
            grpc?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeGrpcPatch>;
            httpGet?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeHttpGetPatch>;
            /**
             * Number of seconds after the container has started before liveness probes are initiated.
             * More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
             */
             ...
             */
            successThreshold?: pulumi.Input<number>;
            tcpSocket?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbeProbeTcpSocketPatch>;
            terminationGracePeriodSeconds?: pulumi.Input<number>;
            /**
             * Number of seconds after which the probe times out.
             * Defaults to 1 second. Minimum value is 1.
         ...
         * TCPSocket specifies a connection to a TCP port.
         */
        export interface CephNVMeOFGatewaySpecLivenessProbeProbeTcpSocket {
            /**
             * Optional: Host name to connect to, defaults to the pod IP.
             */
            host?: pulumi.Input<string>;
         ...
         * TCPSocket specifies a connection to a TCP port.
         */
        export interface CephNVMeOFGatewaySpecLivenessProbeProbeTcpSocketPatch {
            /**
             * Optional: Host name to connect to, defaults to the pod IP.
             */
            host?: pulumi.Input<string>;
         ...
         * NVMeOFGatewaySpec represents the spec of an NVMe-oF gateway
         */
        export interface CephNVMeOFGatewaySpecPatch {
            /**
             * The annotations-related configuration to add/set on each Pod related object.
             */
            annotations?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
             ...
             */
            labels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
            livenessProbe?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecLivenessProbePatch>;
            /**
             * NVMeOFConfig is a map of section names to key-value pairs for nvmeof.conf configuration
             * This allows users to override or add configuration options without needing to manage a ConfigMap
             */
            nvmeofConfig?: pulumi.Input<{[key: string]: pulumi.Input<{[key: string]: pulumi.Input<string>}>}>;
            placement?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPatch>;
            /**
             * Pool is the RADOS pool where NVMe-oF configuration is stored
             */
            pool?: pulumi.Input<string>;
            ports?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPortsPatch>;
            /**
             * PriorityClassName sets the priority class on the pods
             */
            priorityClassName?: pulumi.Input<string>;
            resources?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecResourcesPatch>;
        }

        export interface CephNVMeOFGatewaySpecPlacement {
            nodeAffinity?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinity>;
            podAffinity?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinity>;
            podAntiAffinity?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinity>;
            tolerations?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTolerations>[]>;
            topologySpreadConstraints?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTopologySpreadConstraints>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinity {
            preferredDuringSchedulingIgnoredDuringExecution?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecution>[]>;
            requiredDuringSchedulingIgnoredDuringExecution?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecution>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityPatch {
            preferredDuringSchedulingIgnoredDuringExecution?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPatch>[]>;
            requiredDuringSchedulingIgnoredDuringExecution?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionPatch>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecution {
            preference?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreference>;
            weight?: pulumi.Input<number>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPatch {
            preference?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferencePatch>;
            weight?: pulumi.Input<number>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreference {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpressions>[]>;
            matchFields?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchFields>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpressions {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpressionsPatch {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchFields {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchFieldsPatch {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferencePatch {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchExpressionsPatch>[]>;
            matchFields?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPreferredDuringSchedulingIgnoredDuringExecutionPreferenceMatchFieldsPatch>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecution {
            nodeSelectorTerms?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTerms>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTerms {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchExpressions>[]>;
            matchFields?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchFields>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchExpressions {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchExpressionsPatch {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchFields {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchFieldsPatch {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsPatch {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchExpressionsPatch>[]>;
            matchFields?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsMatchFieldsPatch>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionPatch {
            nodeSelectorTerms?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityRequiredDuringSchedulingIgnoredDuringExecutionNodeSelectorTermsPatch>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPatch {
            nodeAffinity?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementNodeAffinityPatch>;
            podAffinity?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPatch>;
            podAntiAffinity?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPatch>;
            tolerations?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTolerationsPatch>[]>;
            topologySpreadConstraints?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsPatch>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinity {
            preferredDuringSchedulingIgnoredDuringExecution?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecution>[]>;
            requiredDuringSchedulingIgnoredDuringExecution?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecution>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPatch {
            preferredDuringSchedulingIgnoredDuringExecution?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPatch>[]>;
            requiredDuringSchedulingIgnoredDuringExecution?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionPatch>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecution {
            podAffinityTerm?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTerm>;
            weight?: pulumi.Input<number>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPatch {
            podAffinityTerm?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermPatch>;
            weight?: pulumi.Input<number>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTerm {
            labelSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelector>;
            matchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            mismatchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            namespaceSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelector>;
            namespaces?: pulumi.Input<pulumi.Input<string>[]>;
            topologyKey?: pulumi.Input<string>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelector {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorMatchExpressions>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorMatchExpressions {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorMatchExpressionsPatch {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorPatch {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorMatchExpressionsPatch>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelector {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorMatchExpressions>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorMatchExpressions {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorMatchExpressionsPatch {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorPatch {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorMatchExpressionsPatch>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermPatch {
            labelSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorPatch>;
            matchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            mismatchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            namespaceSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorPatch>;
            namespaces?: pulumi.Input<pulumi.Input<string>[]>;
            topologyKey?: pulumi.Input<string>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecution {
            labelSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelector>;
            matchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            mismatchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            namespaceSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelector>;
            namespaces?: pulumi.Input<pulumi.Input<string>[]>;
            topologyKey?: pulumi.Input<string>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelector {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorMatchExpressions>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorMatchExpressions {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorMatchExpressionsPatch {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorPatch {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorMatchExpressionsPatch>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelector {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorMatchExpressions>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorMatchExpressions {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorMatchExpressionsPatch {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorPatch {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorMatchExpressionsPatch>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionPatch {
            labelSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorPatch>;
            matchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            mismatchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            namespaceSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorPatch>;
            namespaces?: pulumi.Input<pulumi.Input<string>[]>;
            topologyKey?: pulumi.Input<string>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinity {
            preferredDuringSchedulingIgnoredDuringExecution?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecution>[]>;
            requiredDuringSchedulingIgnoredDuringExecution?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPatch {
            preferredDuringSchedulingIgnoredDuringExecution?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPatch>[]>;
            requiredDuringSchedulingIgnoredDuringExecution?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionPatch>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecution {
            podAffinityTerm?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTerm>;
            weight?: pulumi.Input<number>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPatch {
            podAffinityTerm?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermPatch>;
            weight?: pulumi.Input<number>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTerm {
            labelSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelector>;
            matchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            mismatchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            namespaceSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelector>;
            namespaces?: pulumi.Input<pulumi.Input<string>[]>;
            topologyKey?: pulumi.Input<string>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelector {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorMatchExpressions>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorMatchExpressions {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorMatchExpressionsPatch {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorPatch {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorMatchExpressionsPatch>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelector {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorMatchExpressions>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorMatchExpressions {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorMatchExpressionsPatch {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorPatch {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorMatchExpressionsPatch>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermPatch {
            labelSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermLabelSelectorPatch>;
            matchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            mismatchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            namespaceSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityPreferredDuringSchedulingIgnoredDuringExecutionPodAffinityTermNamespaceSelectorPatch>;
            namespaces?: pulumi.Input<pulumi.Input<string>[]>;
            topologyKey?: pulumi.Input<string>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution {
            labelSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelector>;
            matchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            mismatchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            namespaceSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelector>;
            namespaces?: pulumi.Input<pulumi.Input<string>[]>;
            topologyKey?: pulumi.Input<string>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelector {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorMatchExpressions>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorMatchExpressions {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorMatchExpressionsPatch {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorPatch {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorMatchExpressionsPatch>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelector {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorMatchExpressions>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorMatchExpressions {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorMatchExpressionsPatch {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorPatch {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorMatchExpressionsPatch>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionPatch {
            labelSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelectorPatch>;
            matchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            mismatchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            namespaceSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionNamespaceSelectorPatch>;
            namespaces?: pulumi.Input<pulumi.Input<string>[]>;
            topologyKey?: pulumi.Input<string>;
        }

        export interface CephNVMeOFGatewaySpecPlacementTolerations {
            effect?: pulumi.Input<string>;
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            tolerationSeconds?: pulumi.Input<number>;
        ...
        export interface CephNVMeOFGatewaySpecPlacementTolerationsPatch {
            effect?: pulumi.Input<string>;
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            tolerationSeconds?: pulumi.Input<number>;
        ...
        export interface CephNVMeOFGatewaySpecPlacementTopologySpreadConstraints {
            labelSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsLabelSelector>;
            matchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            maxSkew?: pulumi.Input<number>;
            minDomains?: pulumi.Input<number>;
            nodeAffinityPolicy?: pulumi.Input<string>;
        ...
        export interface CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsLabelSelector {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsLabelSelectorMatchExpressions>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsLabelSelectorMatchExpressions {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsLabelSelectorMatchExpressionsPatch {
            key?: pulumi.Input<string>;
            operator?: pulumi.Input<string>;
            values?: pulumi.Input<pulumi.Input<string>[]>;
        }

        export interface CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsLabelSelectorPatch {
            matchExpressions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsLabelSelectorMatchExpressionsPatch>[]>;
            matchLabels?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
        }

        export interface CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsPatch {
            labelSelector?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecPlacementTopologySpreadConstraintsLabelSelectorPatch>;
            matchLabelKeys?: pulumi.Input<pulumi.Input<string>[]>;
            maxSkew?: pulumi.Input<number>;
            minDomains?: pulumi.Input<number>;
            nodeAffinityPolicy?: pulumi.Input<string>;
         ...
         */
        export interface CephNVMeOFGatewaySpecPorts {
            /**
             * DiscoveryPort is the port for discovery service (default: 8009)
             */
            discoveryPort?: pulumi.Input<number>;
            /**
         ...
         * Ports configuration for the NVMe-oF gateway
         */
        export interface CephNVMeOFGatewaySpecPortsPatch {
            /**
             * DiscoveryPort is the port for discovery service (default: 8009)
             */
            discoveryPort?: pulumi.Input<number>;
         ...
         * Resources set resource requests and limits
         */
        export interface CephNVMeOFGatewaySpecResources {
            /**
             * Claims lists the names of resources, defined in spec.resourceClaims,
             * that are used by this container.
             *
             ...
             * This field is immutable. It can only be set for containers.
             */
            claims?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecResourcesClaims>[]>;
            /**
             * Limits describes the maximum amount of compute resources allowed.
             * More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
             */
         ...
         * ResourceClaim references one entry in PodSpec.ResourceClaims.
         */
        export interface CephNVMeOFGatewaySpecResourcesClaims {
            /**
             * Name must match the name of one entry in pod.spec.resourceClaims of
             * the Pod where this field is used. It makes that resource available
             * inside a container.
         ...
         * ResourceClaim references one entry in PodSpec.ResourceClaims.
         */
        export interface CephNVMeOFGatewaySpecResourcesClaimsPatch {
            /**
             * Name must match the name of one entry in pod.spec.resourceClaims of
             * the Pod where this field is used. It makes that resource available
             * inside a container.
         ...
         * Resources set resource requests and limits
         */
        export interface CephNVMeOFGatewaySpecResourcesPatch {
            /**
             * Claims lists the names of resources, defined in spec.resourceClaims,
             * that are used by this container.
             *
             ...
             * This field is immutable. It can only be set for containers.
             */
            claims?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewaySpecResourcesClaimsPatch>[]>;
            /**
             * Limits describes the maximum amount of compute resources allowed.
             * More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
             */
         ...
         */
        export interface CephNVMeOFGatewayStatus {
            cephx?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewayStatusCephx>;
            conditions?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewayStatusConditions>[]>;
            /**
             * ObservedGeneration is the latest generation observed by the controller.
             */
            observedGeneration?: pulumi.Input<number>;
        ...
        export interface CephNVMeOFGatewayStatusCephx {
            daemon?: pulumi.Input<inputs.ceph.v1.CephNVMeOFGatewayStatusCephxDaemon>;
        }

        /**
         * Daemon shows the CephX key status for local Ceph daemons associated with this resources.
         */
        export interface CephNVMeOFGatewayStatusCephxDaemon {
            /**
             * KeyCephVersion reports the Ceph version that created the current generation's keys. This is
             * same string format as reported by `CephCluster.status.version.version` to allow them to be
             * compared. E.g., `20.2.0-0`.
         ...
         * Condition represents a status condition on any Rook-Ceph Custom Resource.
         */
        export interface CephNVMeOFGatewayStatusConditions {
            lastHeartbeatTime?: pulumi.Input<string>;
            lastTransitionTime?: pulumi.Input<string>;
            message?: pulumi.Input<string>;
            /**
        ...
        export interface CephObjectRealmSpec {
             ...
             */
            defaultRealm?: pulumi.Input<boolean>;
        ...
        export interface CephObjectStoreSpecGateway {
             ...
             */
            priorityClassName?: pulumi.Input<string>;
            readAffinity?: pulumi.Input<inputs.ceph.v1.CephObjectStoreSpecGatewayReadAffinity>;
            /**
             ...
             */
            rgwCommandFlags?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
            /**
             ...
             * applied. Use with caution.
             */
            rgwConfig?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
            /**
             ...
             * applied. Use with caution.
             */
            rgwConfigFromSecret?: pulumi.Input<{[key: string]: pulumi.Input<{[key: string]: pulumi.Input<string>}>}>;
            /**
        ...
        export interface CephObjectStoreSpecGatewayAdditionalVolumeMountsVolumeSourceProjectedSources {
            ...
            podCertificate?: pulumi.Input<inputs.ceph.v1.CephObjectStoreSpecGatewayAdditionalVolumeMountsVolumeSourceProjectedSourcesPodCertificate>;
        ...
        export interface CephObjectStoreSpecGatewayAdditionalVolumeMountsVolumeSourceProjectedSourcesPatch {
            ...
            podCertificate?: pulumi.Input<inputs.ceph.v1.CephObjectStoreSpecGatewayAdditionalVolumeMountsVolumeSourceProjectedSourcesPodCertificatePatch>;
        ...
        export interface CephObjectStoreSpecGatewayAdditionalVolumeMountsVolumeSourceProjectedSourcesPodCertificate {
            certificateChainPath?: pulumi.Input<string>;
            credentialBundlePath?: pulumi.Input<string>;
            keyPath?: pulumi.Input<string>;
            keyType?: pulumi.Input<string>;
        ...
        export interface CephObjectStoreSpecGatewayAdditionalVolumeMountsVolumeSourceProjectedSourcesPodCertificatePatch {
            certificateChainPath?: pulumi.Input<string>;
            credentialBundlePath?: pulumi.Input<string>;
            keyPath?: pulumi.Input<string>;
            keyType?: pulumi.Input<string>;
        ...
        export interface CephObjectStoreSpecGatewayPatch {
             ...
             */
            priorityClassName?: pulumi.Input<string>;
            readAffinity?: pulumi.Input<inputs.ceph.v1.CephObjectStoreSpecGatewayReadAffinityPatch>;
            /**
             * The resource requirements for the rgw pods
             */
            resources?: pulumi.Input<{[key: string]: any}>;
         ...
         */
        export interface CephObjectStoreSpecGatewayReadAffinity {
            /**
         ...
         * Note: Only supported from Ceph Tentacle (v20)
         */
        export interface CephObjectStoreSpecGatewayReadAffinityPatch {
            /**
             * Type defines the RGW ReadAffinity type
             * localize: read from the nearest OSD based on crush location of the RGW client
             * balance: picks a random OSD from the PG's active set
        ...
        export interface CephObjectStoreUserSpec {
             ...
             * will generate them.
             */
            keys?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephObjectStoreUserSpecKeys>[]>;
            /**
             * The op-mask of the user.
             */
            opMask?: pulumi.Input<pulumi.Input<string>[]>;
         ...
         */
        export interface CephObjectStoreUserSpecKeys {
            accessKeyRef?: pulumi.Input<inputs.ceph.v1.CephObjectStoreUserSpecKeysAccessKeyRef>;
            secretKeyRef?: pulumi.Input<inputs.ceph.v1.CephObjectStoreUserSpecKeysSecretKeyRef>;
        }

        /**
         * Secret key selector for the access_key (commonly referred to as AWS_ACCESS_KEY_ID).
         */
        export interface CephObjectStoreUserSpecKeysAccessKeyRef {
            /**
             * The key of the secret to select from.  Must be a valid secret key.
             */
            key?: pulumi.Input<string>;
         ...
         * Secret key selector for the access_key (commonly referred to as AWS_ACCESS_KEY_ID).
         */
        export interface CephObjectStoreUserSpecKeysAccessKeyRefPatch {
            /**
             * The key of the secret to select from.  Must be a valid secret key.
             */
            key?: pulumi.Input<string>;
         ...
         * from secret resources.
         */
        export interface CephObjectStoreUserSpecKeysPatch {
            accessKeyRef?: pulumi.Input<inputs.ceph.v1.CephObjectStoreUserSpecKeysAccessKeyRefPatch>;
            secretKeyRef?: pulumi.Input<inputs.ceph.v1.CephObjectStoreUserSpecKeysSecretKeyRefPatch>;
        }

        /**
         * Secret key selector for the secret_key (commonly referred to as AWS_SECRET_ACCESS_KEY).
         */
        export interface CephObjectStoreUserSpecKeysSecretKeyRef {
            /**
             * The key of the secret to select from.  Must be a valid secret key.
             */
            key?: pulumi.Input<string>;
         ...
         * Secret key selector for the secret_key (commonly referred to as AWS_SECRET_ACCESS_KEY).
         */
        export interface CephObjectStoreUserSpecKeysSecretKeyRefPatch {
            /**
             * The key of the secret to select from.  Must be a valid secret key.
             */
            key?: pulumi.Input<string>;
        ...
        export interface CephObjectStoreUserSpecPatch {
             ...
             * will generate them.
             */
            keys?: pulumi.Input<pulumi.Input<inputs.ceph.v1.CephObjectStoreUserSpecKeysPatch>[]>;
            /**
             * The op-mask of the user.
             */
            opMask?: pulumi.Input<pulumi.Input<string>[]>;
