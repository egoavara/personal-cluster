 ...
 */
export class CephBucketNotification extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CephBucketNotification {
        return new CephBucketNotification(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:ceph.rook.io/v1:CephBucketNotification';

    /**
     * Returns true if the given object is an instance of CephBucketNotification.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CephBucketNotification {
    ...
    declare public readonly spec: pulumi.Output<outputs.ceph.v1.CephBucketNotificationSpec>;
    /**
