 ...
 */
export class CephObjectStoreList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CephObjectStoreList {
        return new CephObjectStoreList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:ceph.rook.io/v1:CephObjectStoreList';

    /**
     * Returns true if the given object is an instance of CephObjectStoreList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CephObjectStoreList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CephObjectStoreList.__pulumiType;
    }
     ...
     */
    declare public readonly items: pulumi.Output<outputs.ceph.v1.CephObjectStore[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    declare public readonly kind: pulumi.Output<"CephObjectStoreList">;
    /**
    ...
    constructor(name: string, args?: CephObjectStoreListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "CephObjectStoreList";
        ...
        super(CephObjectStoreList.__pulumiType, name, resourceInputs, opts);
    }
}
