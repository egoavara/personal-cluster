 ...
 */
export class CephClientList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CephClientList {
        return new CephClientList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:ceph.rook.io/v1:CephClientList';

    /**
     * Returns true if the given object is an instance of CephClientList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CephClientList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CephClientList.__pulumiType;
    }
     ...
     */
    declare public readonly items: pulumi.Output<outputs.ceph.v1.CephClient[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    declare public readonly kind: pulumi.Output<"CephClientList">;
    /**
    ...
    constructor(name: string, args?: CephClientListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "CephClientList";
        ...
        super(CephClientList.__pulumiType, name, resourceInputs, opts);
    }
}
