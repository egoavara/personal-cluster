...
export { CephNVMeOFGatewayArgs } from "./cephNVMeOFGateway";
export type CephNVMeOFGateway = import("./cephNVMeOFGateway").CephNVMeOFGateway;
export const CephNVMeOFGateway: typeof import("./cephNVMeOFGateway").CephNVMeOFGateway = null as any;
utilities.lazyLoad(exports, ["CephNVMeOFGateway"], () => require("./cephNVMeOFGateway"));

export { CephNVMeOFGatewayListArgs } from "./cephNVMeOFGatewayList";
export type CephNVMeOFGatewayList = import("./cephNVMeOFGatewayList").CephNVMeOFGatewayList;
export const CephNVMeOFGatewayList: typeof import("./cephNVMeOFGatewayList").CephNVMeOFGatewayList = null as any;
utilities.lazyLoad(exports, ["CephNVMeOFGatewayList"], () => require("./cephNVMeOFGatewayList"));

export { CephNVMeOFGatewayPatchArgs } from "./cephNVMeOFGatewayPatch";
export type CephNVMeOFGatewayPatch = import("./cephNVMeOFGatewayPatch").CephNVMeOFGatewayPatch;
export const CephNVMeOFGatewayPatch: typeof import("./cephNVMeOFGatewayPatch").CephNVMeOFGatewayPatch = null as any;
utilities.lazyLoad(exports, ["CephNVMeOFGatewayPatch"], () => require("./cephNVMeOFGatewayPatch"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "kubernetes:ceph.rook.io/v1:CephNVMeOFGateway":
                return new CephNVMeOFGateway(name, <any>undefined, { urn })
            case "kubernetes:ceph.rook.io/v1:CephNVMeOFGatewayList":
                return new CephNVMeOFGatewayList(name, <any>undefined, { urn })
            case "kubernetes:ceph.rook.io/v1:CephNVMeOFGatewayPatch":
                return new CephNVMeOFGatewayPatch(name, <any>undefined, { urn })
