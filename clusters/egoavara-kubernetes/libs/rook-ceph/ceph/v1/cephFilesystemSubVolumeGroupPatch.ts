 ...
 */
export class CephFilesystemSubVolumeGroupPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CephFilesystemSubVolumeGroupPatch {
        return new CephFilesystemSubVolumeGroupPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:ceph.rook.io/v1:CephFilesystemSubVolumeGroupPatch';
     ...
     */
    public static isInstance(obj: any): obj is CephFilesystemSubVolumeGroupPatch {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CephFilesystemSubVolumeGroupPatch.__pulumiType;
    }
     ...
     */
    declare public readonly kind: pulumi.Output<"CephFilesystemSubVolumeGroup">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    declare public readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    declare public readonly spec: pulumi.Output<outputs.ceph.v1.CephFilesystemSubVolumeGroupSpecPatch>;
    /**
    ...
    constructor(name: string, args?: CephFilesystemSubVolumeGroupPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CephFilesystemSubVolumeGroupPatch.__pulumiType, name, resourceInputs, opts);
    }
}
