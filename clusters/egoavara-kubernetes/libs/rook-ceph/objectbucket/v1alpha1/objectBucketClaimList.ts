 ...
 */
export class ObjectBucketClaimList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ObjectBucketClaimList {
        return new ObjectBucketClaimList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:objectbucket.io/v1alpha1:ObjectBucketClaimList';

    /**
     * Returns true if the given object is an instance of ObjectBucketClaimList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectBucketClaimList {
     ...
     */
    declare public readonly items: pulumi.Output<outputs.objectbucket.v1alpha1.ObjectBucketClaim[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    declare public readonly kind: pulumi.Output<"ObjectBucketClaimList">;
    /**
