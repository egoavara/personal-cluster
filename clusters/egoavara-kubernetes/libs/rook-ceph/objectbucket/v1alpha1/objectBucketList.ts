 ...
 */
export class ObjectBucketList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ObjectBucketList {
        return new ObjectBucketList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:objectbucket.io/v1alpha1:ObjectBucketList';

    /**
     * Returns true if the given object is an instance of ObjectBucketList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObjectBucketList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObjectBucketList.__pulumiType;
    }
     ...
     */
    declare public readonly items: pulumi.Output<outputs.objectbucket.v1alpha1.ObjectBucket[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    declare public readonly kind: pulumi.Output<"ObjectBucketList">;
    /**
    ...
    constructor(name: string, args?: ObjectBucketListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "ObjectBucketList";
        ...
        super(ObjectBucketList.__pulumiType, name, resourceInputs, opts);
    }
}
