...
export declare class EnterpriseSearch extends pulumi.CustomResource {
    ...
    readonly spec: pulumi.Output<outputs.enterprisesearch.v1.EnterpriseSearchSpec>;
    readonly status: pulumi.Output<outputs.enterprisesearch.v1.EnterpriseSearchStatus>;
    /**
