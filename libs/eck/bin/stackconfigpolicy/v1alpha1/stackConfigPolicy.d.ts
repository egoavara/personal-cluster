 ...
 */
export declare class StackConfigPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): StackConfigPolicy;
    /**
     * Returns true if the given object is an instance of StackConfigPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StackConfigPolicy;
    /**
    ...
    readonly spec: pulumi.Output<outputs.stackconfigpolicy.v1alpha1.StackConfigPolicySpec>;
    readonly status: pulumi.Output<outputs.stackconfigpolicy.v1alpha1.StackConfigPolicyStatus>;
    /**
