...
export declare class Kibana extends pulumi.CustomResource {
     ...
     */
    readonly apiVersion: pulumi.Output<"kibana.k8s.elastic.co/v1">;
    /**
    ...
    readonly spec: pulumi.Output<outputs.kibana.v1.KibanaSpec>;
    readonly status: pulumi.Output<outputs.kibana.v1.KibanaStatus>;
    /**
