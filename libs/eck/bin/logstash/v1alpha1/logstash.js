 ...
 */
class Logstash extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new Logstash(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
Logstash.__pulumiType = 'kubernetes:logstash.k8s.elastic.co/v1alpha1:Logstash';
