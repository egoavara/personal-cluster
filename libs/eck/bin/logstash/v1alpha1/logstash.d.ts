 ...
 */
export declare class Logstash extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Logstash;
    /**
     * Returns true if the given object is an instance of Logstash.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Logstash;
    /**
    ...
    readonly spec: pulumi.Output<outputs.logstash.v1alpha1.LogstashSpec>;
    readonly status: pulumi.Output<outputs.logstash.v1alpha1.LogstashStatus>;
    /**
