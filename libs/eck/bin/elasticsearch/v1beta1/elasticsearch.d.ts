...
export declare class Elasticsearch extends pulumi.CustomResource {
    ...
    readonly spec: pulumi.Output<outputs.elasticsearch.v1beta1.ElasticsearchSpec>;
    readonly status: pulumi.Output<outputs.elasticsearch.v1beta1.ElasticsearchStatus>;
    /**
