...
exports.CephObjectRealm = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
/**
 * CephObjectRealm represents a Ceph Object Store Gateway Realm
 */
class CephObjectRealm extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new CephObjectRealm(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.CephObjectRealm = CephObjectRealm;
/** @internal */
CephObjectRealm.__pulumiType = 'kubernetes:ceph.rook.io/v1:CephObjectRealm';
//# sourceMappingURL=cephObjectRealm.js.map