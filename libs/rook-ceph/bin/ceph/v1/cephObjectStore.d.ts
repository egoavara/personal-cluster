 ...
 */
export declare class CephObjectStore extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CephObjectStore;
    /**
     * Returns true if the given object is an instance of CephObjectStore.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CephObjectStore;
    /**
    ...
    readonly spec: pulumi.Output<outputs.ceph.v1.CephObjectStoreSpec>;
    /**
