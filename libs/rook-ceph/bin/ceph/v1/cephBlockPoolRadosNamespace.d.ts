 ...
 */
export declare class CephBlockPoolRadosNamespace extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CephBlockPoolRadosNamespace;
    /**
     ...
     */
    static isInstance(obj: any): obj is CephBlockPoolRadosNamespace;
    /**
    ...
    readonly spec: pulumi.Output<outputs.ceph.v1.CephBlockPoolRadosNamespaceSpec>;
    /**
