 ...
 */
export declare class CephObjectZone extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CephObjectZone;
    /**
     * Returns true if the given object is an instance of CephObjectZone.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CephObjectZone;
    /**
    ...
    readonly spec: pulumi.Output<outputs.ceph.v1.CephObjectZoneSpec>;
    /**
