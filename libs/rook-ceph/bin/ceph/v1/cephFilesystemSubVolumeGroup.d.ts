 ...
 */
export declare class CephFilesystemSubVolumeGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CephFilesystemSubVolumeGroup;
    /**
     ...
     */
    static isInstance(obj: any): obj is CephFilesystemSubVolumeGroup;
    /**
    ...
    readonly spec: pulumi.Output<outputs.ceph.v1.CephFilesystemSubVolumeGroupSpec>;
    /**
