...
export declare class ObjectBucket extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ObjectBucket;
    /**
    ...
    readonly spec: pulumi.Output<outputs.objectbucket.v1alpha1.ObjectBucketSpec>;
