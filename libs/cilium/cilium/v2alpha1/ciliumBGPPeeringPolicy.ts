 ...
 */
export class CiliumBGPPeeringPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumBGPPeeringPolicy {
        return new CiliumBGPPeeringPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2alpha1:CiliumBGPPeeringPolicy';

    /**
     * Returns true if the given object is an instance of CiliumBGPPeeringPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CiliumBGPPeeringPolicy {
    ...
    declare public readonly spec: pulumi.Output<outputs.cilium.v2alpha1.CiliumBGPPeeringPolicySpec>;
