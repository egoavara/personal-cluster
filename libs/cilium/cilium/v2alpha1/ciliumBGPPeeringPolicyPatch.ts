 ...
 */
export class CiliumBGPPeeringPolicyPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CiliumBGPPeeringPolicyPatch {
        return new CiliumBGPPeeringPolicyPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cilium.io/v2alpha1:CiliumBGPPeeringPolicyPatch';
     ...
     */
    public static isInstance(obj: any): obj is CiliumBGPPeeringPolicyPatch {
     ...
     */
    declare public readonly kind: pulumi.Output<"CiliumBGPPeeringPolicy">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    declare public readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    declare public readonly spec: pulumi.Output<outputs.cilium.v2alpha1.CiliumBGPPeeringPolicySpecPatch>;
