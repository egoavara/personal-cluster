...
export class AuthorizationPolicyList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:security.istio.io/v1beta1:AuthorizationPolicyList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.security.v1beta1.AuthorizationPolicy[]>;
    /**
