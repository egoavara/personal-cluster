 ...
 */
export class RequestAuthenticationList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RequestAuthenticationList {
        return new RequestAuthenticationList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:security.istio.io/v1beta1:RequestAuthenticationList';
     ...
     */
    public static isInstance(obj: any): obj is RequestAuthenticationList {
     ...
     */
    public readonly items!: pulumi.Output<outputs.security.v1beta1.RequestAuthentication[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    public readonly kind!: pulumi.Output<"RequestAuthenticationList">;
    /**
