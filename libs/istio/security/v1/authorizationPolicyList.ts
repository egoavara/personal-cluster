 ...
 */
export class AuthorizationPolicyList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AuthorizationPolicyList {
        return new AuthorizationPolicyList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:security.istio.io/v1:AuthorizationPolicyList';

    /**
     * Returns true if the given object is an instance of AuthorizationPolicyList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AuthorizationPolicyList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AuthorizationPolicyList.__pulumiType;
    }
     ...
     */
    public readonly items!: pulumi.Output<outputs.security.v1.AuthorizationPolicy[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    public readonly kind!: pulumi.Output<"AuthorizationPolicyList">;
    /**
    ...
    constructor(name: string, args?: AuthorizationPolicyListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "AuthorizationPolicyList";
        ...
        super(AuthorizationPolicyList.__pulumiType, name, resourceInputs, opts);
    }
}
