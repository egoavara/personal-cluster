...
export class RequestAuthenticationList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:security.istio.io/v1:RequestAuthenticationList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.security.v1.RequestAuthentication[]>;
    /**
