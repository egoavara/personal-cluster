...
export class PeerAuthentication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:security.istio.io/v1:PeerAuthentication';
    ...
    public readonly spec!: pulumi.Output<outputs.security.v1.PeerAuthenticationSpec>;
    ...
    constructor(name: string, args?: PeerAuthenticationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:security.istio.io/v1beta1:PeerAuthentication" }] };
