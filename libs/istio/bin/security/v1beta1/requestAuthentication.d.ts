...
export declare class RequestAuthentication extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RequestAuthentication;
    /**
     * Returns true if the given object is an instance of RequestAuthentication.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RequestAuthentication;
    /**
    ...
    readonly spec: pulumi.Output<outputs.security.v1beta1.RequestAuthenticationSpec>;
