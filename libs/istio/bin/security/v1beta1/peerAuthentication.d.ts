...
export declare class PeerAuthentication extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PeerAuthentication;
    /**
     * Returns true if the given object is an instance of PeerAuthentication.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PeerAuthentication;
    /**
    ...
    readonly spec: pulumi.Output<outputs.security.v1beta1.PeerAuthenticationSpec>;
