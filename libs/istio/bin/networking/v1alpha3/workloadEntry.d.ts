...
export declare class WorkloadEntry extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): WorkloadEntry;
    /**
     * Returns true if the given object is an instance of WorkloadEntry.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkloadEntry;
    /**
    ...
    readonly spec: pulumi.Output<outputs.networking.v1alpha3.WorkloadEntrySpec>;
