...
export declare class EnvoyFilter extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EnvoyFilter;
    /**
     * Returns true if the given object is an instance of EnvoyFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EnvoyFilter;
    /**
    ...
    readonly spec: pulumi.Output<outputs.networking.v1alpha3.EnvoyFilterSpec>;
