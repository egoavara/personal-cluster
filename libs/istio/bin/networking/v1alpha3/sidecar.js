...
class Sidecar extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.istio.io/v1:Sidecar" }, { type: "kubernetes:networking.istio.io/v1beta1:Sidecar" }] };
...
/** @internal */
Sidecar.__pulumiType = 'kubernetes:networking.istio.io/v1alpha3:Sidecar';
