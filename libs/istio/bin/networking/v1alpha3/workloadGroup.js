...
class WorkloadGroup extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.istio.io/v1:WorkloadGroup" }, { type: "kubernetes:networking.istio.io/v1beta1:WorkloadGroup" }] };
...
/** @internal */
WorkloadGroup.__pulumiType = 'kubernetes:networking.istio.io/v1alpha3:WorkloadGroup';
