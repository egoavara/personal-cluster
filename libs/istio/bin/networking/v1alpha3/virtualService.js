...
class VirtualService extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.istio.io/v1:VirtualService" }, { type: "kubernetes:networking.istio.io/v1beta1:VirtualService" }] };
...
/** @internal */
VirtualService.__pulumiType = 'kubernetes:networking.istio.io/v1alpha3:VirtualService';
