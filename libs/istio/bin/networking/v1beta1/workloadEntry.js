...
exports.WorkloadEntry = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
class WorkloadEntry extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new WorkloadEntry(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.istio.io/v1:WorkloadEntry" }, { type: "kubernetes:networking.istio.io/v1alpha3:WorkloadEntry" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(WorkloadEntry.__pulumiType, name, resourceInputs, opts);
    }
}
exports.WorkloadEntry = WorkloadEntry;
/** @internal */
WorkloadEntry.__pulumiType = 'kubernetes:networking.istio.io/v1beta1:WorkloadEntry';
//# sourceMappingURL=workloadEntry.js.map