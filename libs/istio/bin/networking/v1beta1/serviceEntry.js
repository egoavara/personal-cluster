...
class ServiceEntry extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.istio.io/v1:ServiceEntry" }, { type: "kubernetes:networking.istio.io/v1alpha3:ServiceEntry" }] };
...
/** @internal */
ServiceEntry.__pulumiType = 'kubernetes:networking.istio.io/v1beta1:ServiceEntry';
