...
class DestinationRule extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.istio.io/v1:DestinationRule" }, { type: "kubernetes:networking.istio.io/v1alpha3:DestinationRule" }] };
...
/** @internal */
DestinationRule.__pulumiType = 'kubernetes:networking.istio.io/v1beta1:DestinationRule';
