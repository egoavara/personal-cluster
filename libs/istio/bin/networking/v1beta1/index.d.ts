...
export declare const ProxyConfig: typeof import("./proxyConfig").ProxyConfig;
export { ProxyConfigListArgs } from "./proxyConfigList";
export type ProxyConfigList = import("./proxyConfigList").ProxyConfigList;
export declare const ProxyConfigList: typeof import("./proxyConfigList").ProxyConfigList;
export { ProxyConfigPatchArgs } from "./proxyConfigPatch";
export type ProxyConfigPatch = import("./proxyConfigPatch").ProxyConfigPatch;
export declare const ProxyConfigPatch: typeof import("./proxyConfigPatch").ProxyConfigPatch;
