...
export declare class ProxyConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ProxyConfig;
    /**
     * Returns true if the given object is an instance of ProxyConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProxyConfig;
    /**
    ...
    readonly spec: pulumi.Output<outputs.networking.v1beta1.ProxyConfigSpec>;
