...
exports.DestinationRule = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../../utilities");
class DestinationRule extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new DestinationRule(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.istio.io/v1alpha3:DestinationRule" }, { type: "kubernetes:networking.istio.io/v1beta1:DestinationRule" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(DestinationRule.__pulumiType, name, resourceInputs, opts);
    }
}
exports.DestinationRule = DestinationRule;
/** @internal */
DestinationRule.__pulumiType = 'kubernetes:networking.istio.io/v1:DestinationRule';
//# sourceMappingURL=destinationRule.js.map