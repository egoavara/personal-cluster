...
class WorkloadEntry extends pulumi.CustomResource {
    ...
    constructor(name, args, opts) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.istio.io/v1alpha3:WorkloadEntry" }, { type: "kubernetes:networking.istio.io/v1beta1:WorkloadEntry" }] };
...
/** @internal */
WorkloadEntry.__pulumiType = 'kubernetes:networking.istio.io/v1:WorkloadEntry';
