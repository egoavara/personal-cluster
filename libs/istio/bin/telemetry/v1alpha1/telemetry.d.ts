...
export declare class Telemetry extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Telemetry;
    /**
     * Returns true if the given object is an instance of Telemetry.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Telemetry;
    /**
    ...
    readonly spec: pulumi.Output<outputs.telemetry.v1alpha1.TelemetrySpec>;
