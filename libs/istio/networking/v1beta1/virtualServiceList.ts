...
export class VirtualServiceList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1beta1:VirtualServiceList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.networking.v1beta1.VirtualService[]>;
    /**
