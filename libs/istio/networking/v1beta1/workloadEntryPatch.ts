...
export class WorkloadEntryPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1beta1:WorkloadEntryPatch';
    ...
    public readonly spec!: pulumi.Output<outputs.networking.v1beta1.WorkloadEntrySpecPatch>;
