...
export class GatewayList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1beta1:GatewayList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.networking.v1beta1.Gateway[]>;
    /**
