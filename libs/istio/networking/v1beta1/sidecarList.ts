...
export class SidecarList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1beta1:SidecarList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.networking.v1beta1.Sidecar[]>;
    /**
