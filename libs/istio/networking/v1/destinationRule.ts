...
export class DestinationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1:DestinationRule';
    ...
    public readonly spec!: pulumi.Output<outputs.networking.v1.DestinationRuleSpec>;
