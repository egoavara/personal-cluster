...
export class Gateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1:Gateway';
    ...
    public readonly spec!: pulumi.Output<outputs.networking.v1.GatewaySpec>;
    ...
    constructor(name: string, args?: GatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.istio.io/v1alpha3:Gateway" }, { type: "kubernetes:networking.istio.io/v1beta1:Gateway" }] };
