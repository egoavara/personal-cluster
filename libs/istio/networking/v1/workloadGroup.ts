...
export class WorkloadGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1:WorkloadGroup';
    ...
    public readonly spec!: pulumi.Output<outputs.networking.v1.WorkloadGroupSpec>;
    ...
    constructor(name: string, args?: WorkloadGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.istio.io/v1alpha3:WorkloadGroup" }, { type: "kubernetes:networking.istio.io/v1beta1:WorkloadGroup" }] };
