...
export class VirtualService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1:VirtualService';
    ...
    public readonly spec!: pulumi.Output<outputs.networking.v1.VirtualServiceSpec>;
