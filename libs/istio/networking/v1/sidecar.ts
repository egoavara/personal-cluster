...
export class Sidecar extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1:Sidecar';
    ...
    public readonly spec!: pulumi.Output<outputs.networking.v1.SidecarSpec>;
    ...
    constructor(name: string, args?: SidecarArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.istio.io/v1alpha3:Sidecar" }, { type: "kubernetes:networking.istio.io/v1beta1:Sidecar" }] };
