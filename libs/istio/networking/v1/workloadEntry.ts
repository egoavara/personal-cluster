...
export class WorkloadEntry extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1:WorkloadEntry';
    ...
    public readonly spec!: pulumi.Output<outputs.networking.v1.WorkloadEntrySpec>;
