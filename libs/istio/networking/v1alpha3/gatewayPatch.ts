...
export class GatewayPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1alpha3:GatewayPatch';
    ...
    public readonly spec!: pulumi.Output<outputs.networking.v1alpha3.GatewaySpecPatch>;
    ...
    constructor(name: string, args?: GatewayPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:networking.istio.io/v1:GatewayPatch" }, { type: "kubernetes:networking.istio.io/v1beta1:GatewayPatch" }] };
