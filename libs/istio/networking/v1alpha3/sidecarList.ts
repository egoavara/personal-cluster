...
export class SidecarList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1alpha3:SidecarList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.networking.v1alpha3.Sidecar[]>;
    /**
