...
export class DestinationRuleList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1alpha3:DestinationRuleList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.networking.v1alpha3.DestinationRule[]>;
    /**
